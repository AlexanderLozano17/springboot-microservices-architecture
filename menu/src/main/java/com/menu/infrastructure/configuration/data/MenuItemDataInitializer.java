        ...
        if (menuItemJpaRepository.count() == 0) {
            ...
            try {
                ...
                List<MenuItemEntity> menuItems = List.of(
                    ...
                    new MenuItemEntity("Ajiaco Tradicional", "Nuestro famoso ajiaco con crema y alcaparras.", new BigDecimal("25.00"), true, platosFuertesCategory, ajiacoDish),
                    new MenuItemEntity("Lomo al Carbón con Arroz y Papa", "Jugoso lomo al carbón acompañado de arroz y papas.", new BigDecimal("35.00"), true, platosFuertesCategory, lomoDish),
                    new MenuItemEntity("Limonada Fresca", "Limonada 100% natural.", new BigDecimal("5.00"), true, bebidasCategory, limonadaDish),
